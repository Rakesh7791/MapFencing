package com.rakesh.fencingmapdemo;
...
//////
    ...
    public void onMapClick(LatLng latLng) {
       ...
       /* if (checkClick == false) {
            map.addMarker(new MarkerOptions().position(latLng).icon( BitmapDescriptorFactory.fromResource(R.drawable.ic_action_location)));
